...
def nivel():
    ...
    enemigos = Enemigo.crear_lista_enemigos(cantidad=4, col=6, fil=1, speed=1, frame=50, move=20, jugador=personaje_princ, life=200, daño=3, bandera=True, tipo='normal')
    ...
    while True:
        ...
        if len(enemigos) <= 0 and tiempo_regresivo > 1 and tiempo_regresivo <= 50:
            enemigos = Enemigo.crear_lista_enemigos(cantidad=8, col=6, fil=1, speed=1, frame=50, move=20, jugador=personaje_princ, life=200, daño=3, bandera=True, tipo='normal')
